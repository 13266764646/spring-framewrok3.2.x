...
public abstract class AbstractRefreshableApplicationContext extends AbstractApplicationContext {
	...
	protected final void refreshBeanFactory() throws BeansException {
		...
		try {
			//在介绍BeanFactory的时候，声明方式为BeanFactory bf = new XmlBeanFactory("beanFactoryTest.xml"),
			//其中的xmlBeanFactory继承自DefaultListableBeanFactory，并提供了xmlBeanDefinitionReader类型的reader属性，
			//也就是说DefaultListableBeanFactory是容器的基础。必须首选要实例化，那么在这里就是实例化DefaultListableBeanFactory的步骤。
